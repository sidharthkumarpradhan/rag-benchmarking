...
const RAG_STYLES = {
  ...
  vectorless:   { label: 'PageIndex RAG', color: 'text-emerald-600', bg: 'bg-emerald-50', border: 'border-emerald-200', dot: 'bg-emerald-500', desc: 'PageIndex: hierarchical tree index + LLM reasoning (no vector DB)' },
